...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.document-core|current/StructureDefinition/StructureDefinition-fr-conclusion-extension.json)
...
Other representations of profile: [CSV](../StructureDefinition-fr-conclusion-extension.csv), [Excel](../StructureDefinition-fr-conclusion-extension.xlsx), [Schematron](../StructureDefinition-fr-conclusion-extension.sch) 
