...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.document-core|current/StructureDefinition/StructureDefinition-fr-finding-extension.json)
...
Other representations of profile: [CSV](../StructureDefinition-fr-finding-extension.csv), [Excel](../StructureDefinition-fr-finding-extension.xlsx), [Schematron](../StructureDefinition-fr-finding-extension.sch) 
