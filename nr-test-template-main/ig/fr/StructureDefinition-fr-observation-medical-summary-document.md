# Observation - FR Observation Medical Summary Document - FR Document Core (FHIR) v0.1.0

## Profil de ressource: Observation - FR Observation Medical Summary Document 
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.document-core|current/StructureDefinition/fr-observation-medical-summary-document)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-observation-medical-summary-document.csv), [Excel](../StructureDefinition-fr-observation-medical-summary-document.xlsx), [Schematron](../StructureDefinition-fr-observation-medical-summary-document.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/document-core/StructureDefinition/fr-observation-medical-summary-document",
  "version" : "0.1.0",
