...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ServiceRequest">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/5.0/StructureDefinition/extension-ServiceRequest.reason|0.1.0']) &gt;= 2">extension with URL = 'http://hl7.org/fhir/5.0/StructureDefinition/extension-ServiceRequest.reason|0.1.0': minimum cardinality of 'extension' is 2</sch:assert>
