# Observation - FR Observation Transfusion Accidents Document - FR Document Core (FHIR) v0.1.0

## Profil de ressource: Observation - FR Observation Transfusion Accidents Document 
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.document-core|current/StructureDefinition/fr-observation-transfusion-accidents-document)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-observation-transfusion-accidents-document.csv), [Excel](../StructureDefinition-fr-observation-transfusion-accidents-document.xlsx), [Schematron](../StructureDefinition-fr-observation-transfusion-accidents-document.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/document-core/StructureDefinition/fr-observation-transfusion-accidents-document",
  "version" : "0.1.0",
