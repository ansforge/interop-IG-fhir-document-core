# Observation - FR Observation Administration Blood Derivatives Document - FR Document Core (FHIR) v0.1.0

## Profil de ressource: Observation - FR Observation Administration Blood Derivatives Document 
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.document-core|current/StructureDefinition/fr-observation-administration-blood-derivatives-document)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-observation-administration-blood-derivatives-document.csv), [Excel](../StructureDefinition-fr-observation-administration-blood-derivatives-document.xlsx), [Schematron](../StructureDefinition-fr-observation-administration-blood-derivatives-document.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/document-core/StructureDefinition/fr-observation-administration-blood-derivatives-document",
  "version" : "0.1.0",
