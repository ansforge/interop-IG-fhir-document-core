...
## Profil de ressource: Observation - FR Observation Survey Pannel Document 
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.document-core|current/StructureDefinition/fr-observation-survey-pannel-document)
...
* [Observation - FR Observation Survey Document (https://interop.esante.gouv.fr/ig/fhir/document-core/StructureDefinition/fr-observation-survey-document|0.1.0)](StructureDefinition-fr-observation-survey-document.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-observation-survey-pannel-document.csv), [Excel](../StructureDefinition-fr-observation-survey-pannel-document.xlsx), [Schematron](../StructureDefinition-fr-observation-survey-pannel-document.sch) 
