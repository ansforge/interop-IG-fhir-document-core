# Observation - FR Observation Work Related Accident Document - FR Document Core (FHIR) v0.1.0
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.document-core|current/StructureDefinition/fr-observation-work-related-accident-document)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-observation-work-related-accident-document.csv), [Excel](../StructureDefinition-fr-observation-work-related-accident-document.xlsx), [Schematron](../StructureDefinition-fr-observation-work-related-accident-document.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/document-core/StructureDefinition/fr-observation-work-related-accident-document",
  "version" : "0.1.0",
