# Observation - FR Observation Birth Event Document - FR Document Core (FHIR) v0.1.0

## Profil de ressource: Observation - FR Observation Birth Event Document 
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.document-core|current/StructureDefinition/fr-observation-birth-event-document)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-observation-birth-event-document.csv), [Excel](../StructureDefinition-fr-observation-birth-event-document.xlsx), [Schematron](../StructureDefinition-fr-observation-birth-event-document.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/document-core/StructureDefinition/fr-observation-birth-event-document",
  "version" : "0.1.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "constraint" : [{
        ...
        "source" : "https://interop.esante.gouv.fr/ig/fhir/document-core/StructureDefinition/fr-observation-birth-event-document|0.1.0"
      }],
      "mustSupport" : true
    },
    {
