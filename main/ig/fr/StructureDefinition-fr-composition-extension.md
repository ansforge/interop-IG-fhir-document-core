# FR Composition Extension - FR Document Core (FHIR) v0.1.0
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-composition-extension.csv), [Excel](../StructureDefinition-fr-composition-extension.xlsx), [Schematron](../StructureDefinition-fr-composition-extension.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/document-core/StructureDefinition/fr-composition-extension",
  "version" : "0.1.0",
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "https://interop.esante.gouv.fr/ig/fhir/document-core/StructureDefinition/fr-composition-extension"
    },
    {
