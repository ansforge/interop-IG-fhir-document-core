# Patient français - FR Document Core (FHIR) v0.1.0
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.document-core|current/StructureDefinition/fr-patient)
...
* [https://interop.esante.gouv.fr/ig/fhir/document-core/StructureDefinition/EyeColor|0.1.0](StructureDefinition-EyeColor.md)
...
```json
{
  ...
  "id" : "fr-patient",
  "url" : "https://interop.esante.gouv.fr/ig/fhir/document-core/StructureDefinition/fr-patient",
  "version" : "0.1.0",
  "name" : "FrPatient",
  "title" : "Patient français",
  "status" : "draft",
  "date" : "2026-07-03T07:33:03+00:00",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/document-core/StructureDefinition/EyeColor|0.1.0"]
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/document-core/ValueSet/ModifiedAdministrativeGender|0.1.0"
      }
    }]
  }
}
