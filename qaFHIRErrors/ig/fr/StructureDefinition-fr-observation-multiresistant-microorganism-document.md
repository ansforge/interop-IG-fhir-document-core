# Observation - FR Observation Multiresistant Microorganisms Identification Document - FR Document Core (FHIR) v0.1.0

## Profil de ressource: Observation - FR Observation Multiresistant Microorganisms Identification Document 
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.document-core|current/StructureDefinition/fr-observation-multiresistant-microorganism-document)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-observation-multiresistant-microorganism-document.csv), [Excel](../StructureDefinition-fr-observation-multiresistant-microorganism-document.xlsx), [Schematron](../StructureDefinition-fr-observation-multiresistant-microorganism-document.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/document-core/StructureDefinition/fr-observation-multiresistant-microorganism-document",
  "version" : "0.1.0",
