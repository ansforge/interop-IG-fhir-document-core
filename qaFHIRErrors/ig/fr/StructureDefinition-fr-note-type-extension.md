...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.document-core|current/StructureDefinition/fr-note-type-extension)
...
Extension simple avec le type code : Extension permettant de préciser le type d'information contenu dans une note associée à une demande d'examen d'imagerie.
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-note-type-extension.csv), [Excel](../StructureDefinition-fr-note-type-extension.xlsx), [Schematron](../StructureDefinition-fr-note-type-extension.sch) 
