...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fr.fhir.document.core|current/StructureDefinition/StructureDefinition-fr-encounter-care-document.json)
