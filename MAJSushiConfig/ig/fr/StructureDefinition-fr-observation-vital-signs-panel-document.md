...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fr.fhir.document.core|current/StructureDefinition/fr-observation-vital-signs-panel-document)
...
* [Observation - FR Observation Vital Signs Document (https://interop.esante.gouv.fr/ig/fhir/fhir-document-core/StructureDefinition/fr-observation-vital-signs-document|0.1.0)](StructureDefinition-fr-observation-vital-signs-document.md)
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/fhir-document-core/StructureDefinition/fr-observation-vital-signs-panel-document",
  "version" : "0.1.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://interop.esante.gouv.fr/ig/fhir/fhir-document-core/StructureDefinition/fr-observation-vital-signs-document|0.1.0"]
      }]
    }]
  }
}
