...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fr.fhir.document.core|current/StructureDefinition/fr-observation-pregnancy-history-document)
...
* [Observation - FR Observation Pregnancy Document (https://interop.esante.gouv.fr/ig/fhir/fhir-document-core/StructureDefinition/fr-observation-pregnancy-document|0.1.0)](StructureDefinition-fr-observation-pregnancy-document.md)
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/fhir-document-core/StructureDefinition/fr-observation-pregnancy-history-document",
  "version" : "0.1.0",
