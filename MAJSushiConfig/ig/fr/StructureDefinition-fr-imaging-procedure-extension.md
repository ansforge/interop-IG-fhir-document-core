...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fr.fhir.document.core|current/StructureDefinition/fr-imaging-procedure-extension)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-imaging-procedure-extension.csv), [Excel](../StructureDefinition-fr-imaging-procedure-extension.xlsx), [Schematron](../StructureDefinition-fr-imaging-procedure-extension.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/fhir-document-core/StructureDefinition/fr-imaging-procedure-extension",
  "version" : "0.1.0",
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "https://interop.esante.gouv.fr/ig/fhir/fhir-document-core/StructureDefinition/fr-imaging-procedure-extension"
    },
    {
