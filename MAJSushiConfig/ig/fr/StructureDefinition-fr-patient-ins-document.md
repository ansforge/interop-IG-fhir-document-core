...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fr.fhir.document.core|current/StructureDefinition/fr-patient-ins-document)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-patient-ins-document.csv), [Excel](../StructureDefinition-fr-patient-ins-document.xlsx), [Schematron](../StructureDefinition-fr-patient-ins-document.sch) 
