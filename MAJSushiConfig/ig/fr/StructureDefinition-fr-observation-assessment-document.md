...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fr.fhir.document.core|current/StructureDefinition/fr-observation-assessment-document)
...
* [https://interop.esante.gouv.fr/ig/fhir/fhir-document-core/StructureDefinition/fr-status-reason-extension|0.1.0](StructureDefinition-fr-status-reason-extension.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-observation-assessment-document.csv), [Excel](../StructureDefinition-fr-observation-assessment-document.xlsx), [Schematron](../StructureDefinition-fr-observation-assessment-document.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/fhir-document-core/StructureDefinition/fr-observation-assessment-document",
  "version" : "0.1.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/fhir-document-core/StructureDefinition/fr-status-reason-extension|0.1.0"]
      }]
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/fhir-document-core/ValueSet/fr-vs-evaluation-type|0.1.0"
      }
    },
    {
