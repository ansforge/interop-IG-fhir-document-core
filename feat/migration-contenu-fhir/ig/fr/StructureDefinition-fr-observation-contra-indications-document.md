# Observation - FR Observation Contra Indications Document - FR Document Core (FHIR) v0.1.0

## Profil de ressource: Observation - FR Observation Contra Indications Document 
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.document-core|current/StructureDefinition/fr-observation-contra-indications-document)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-observation-contra-indications-document.csv), [Excel](../StructureDefinition-fr-observation-contra-indications-document.xlsx), [Schematron](../StructureDefinition-fr-observation-contra-indications-document.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/document-core/StructureDefinition/fr-observation-contra-indications-document",
  "version" : "0.1.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "preferred",
        "valueSet" : "https://smt.esante.gouv.fr/fhir/ValueSet/jdv-contre-indication-cisis|20260420150249"
      }
    },
    {
