# Observation - FR Observation Microorganism Detection Document - FR Document Core (FHIR) v0.1.0

## Profil de ressource: Observation - FR Observation Microorganism Detection Document 
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.document-core|current/StructureDefinition/fr-observation-microorganism-detection-document)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-observation-microorganism-detection-document.csv), [Excel](../StructureDefinition-fr-observation-microorganism-detection-document.xlsx), [Schematron](../StructureDefinition-fr-observation-microorganism-detection-document.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/document-core/StructureDefinition/fr-observation-microorganism-detection-document",
  "version" : "0.1.0",
